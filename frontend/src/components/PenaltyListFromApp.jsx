...
//         params: {
//           include: "Penalty", // Make sure this matches the association name in the backend
//         },
//       });
//       setAmandes(response.data);
//     } catch (error) {
//       setError("Error fetching amandes. Please try again later.");
//     }
//   };
...
//       try {
//         await axios.delete(`http://localhost:5000/amandes/${amandeId}`);
//         getAmandes();
//       } catch (error) {
//         setError("Error deleting the amande. Please try again later.");
//       }
//     }
//   };
